...
public class StapoviActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        modelsStapovi.add(new StapoviModel(R.drawable.shimanotribal, "Shimano Tribal TX-9A 13ft Intensity", "Cijena: 3172,43 kn", R.string.opisShimanoTribal));
        ...
        modelsStapovi.add(new StapoviModel(R.drawable.freespirithisive, "Free Spirit HI-S ive 13ft", "Cijena: 4227,43 kn", R.string.opisFreeSpiritHI_S_ive));
        ...
        modelsStapovi.add(new StapoviModel(R.drawable.prologicquasar, "Prologic Quasar K1 13ft", "Cijena: 1679,40 kn", R.string.opisPrologicQuasar));
        modelsStapovi.add(new StapoviModel(R.drawable.daiwainfinitydf, "Daiwa Infinity DF 13ft", "Cijena: 1679,40 kn", R.string.opisDaiwaInfinity));
